...
**rmoriedata** is a data-only companion R package for
[rmorie](https://github.com/rootcoder007/rmorie) — it ships bundled
open-data fixtures and nothing else. No exported functions, no business
logic, no analyses.
